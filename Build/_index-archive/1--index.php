...
<body>
            ...
            <div class="slide">
                ...
                <div class="content row">
                    ...
                    <div class="form-container four columns">
                        ...
                        <form id="email-subscription-signup" method="post" action="mail-form.php">
                            <div class="row">
                                <label style="display:none;">First</label>
                                <input class="newsletter-input-fName four columns" type="text" name="name-first" placeholder="First" />
                            ...
                            <div class="row">
                                ...
                                <input class="newsletter-input-eMail ten columns" type="text" name="email-address" placeholder="ex: 2485633987" />
                            </div>
                            <div class="submit-button-cotainer row">
                                <input id="submit-mailing-list-signup" class="newsletter-input-submitButton button-primary" type="submit" value="Submit" />
                            </div>
                        </form>
                    </div>
                    <!-- form-container -->
    ...
    <div id="footer">
        <div class="social-media">
            <ul class="sm-icons">
                <li id="facebook" class="icon"><a href="http://www.facebook.com/uniongeneral"><img src="assets/slices/icon-social-media_FaceBook.png" alt="Icon of FaceBook Logo" /></a></li>
                <li id="instagram" class="icon"><a href="http://www.instagram.com/uniongeneral"><img src="assets/slices/icon-social-media_Instagram.png" alt="Icon of Instagram Logo" /></a></li>
                <li id="pintrest" class="icon"><a href="http://www.pintrest.com/uniongeneral"><img src="assets/slices/icon-social-media_Pintrest.png" alt="Icon of Pintrest Logo" /></a></li>
            </ul>
        </div>
    </div>
</body>
